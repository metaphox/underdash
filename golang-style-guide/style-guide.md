...
2. **[Simplicity](#simplicity)**: The code accomplishes its goal in the simplest way
   possible.
3. **[Concision](#concision)**: The code has a high signal-to-noise ratio.
4. **[Maintainability](#maintainability)**: The code is written such that it can be easily
   maintained.
...
* Maintainer comments in
  [`package sort`](https://cs.opensource.google/go/go/%2B/refs/tags/go1.19.2%3Asrc/sort/sort.go).
* Good
  [runnable examples in the same package](https://cs.opensource.google/go/go/%2B/refs/tags/go1.19.2%3Asrc/sort/example_search_test.go),
...
lines of code to find the changes. [Table-driven testing](https://go.dev/wiki/TableDrivenTests) is a good example of a
...
notice the change. In cases like this, it is worth intentionally [“boosting”](best-practices#signal-boost)
...
This site is open source. [Improve this page](https://github.com/google/styleguide/edit/gh-pages/go/guide.md).